...
namespace DatabindingExample.Util
{
  /// <summary>
  /// Provides a simplified grid markup, where row and column definitions can be expressed as 
  /// simple strings, e.g. "2*,*,Auto".
  /// </summary>
  /// <remarks>
  /// see: http://www.scottlogic.co.uk/blog/colin/2010/12/a-simplified-grid-markup-for-silverlight-and-wpf/
  /// </remarks>
